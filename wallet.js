...
program
    ...
    .option('-k --key [private key]', 'Private wallet key')
    .parse(process.argv);
...
if(!program.key) {
    console.log('Wallet private key required');
    process.exit(3);
}
...
console.log('Wallet address: %s', wallet.getAddress());
//1FJsZyQSPLL5y9McbmYjqs9Lcfdt3RcYzK
